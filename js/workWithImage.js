// Функция, обрабатывающая событие обновления изображения в блоке canvas

// добавляем обработчик события 'change' на изображение
newPic.addEventListener('change', sendImage, false);

// обновляем изображение, комментарии, рисунки
